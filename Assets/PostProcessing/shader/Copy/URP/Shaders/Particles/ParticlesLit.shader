...
Shader "Universal Render Pipeline/Particles/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesLitForwardPass.hlsl"
            ENDHLSL
        }
	    // ------------------------------------------------------------------
        //  GBuffer pass.
        Pass
        {
            ...
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesLitGbufferPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
