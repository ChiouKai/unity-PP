...
Shader "Universal Render Pipeline/Particles/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
        //  GBuffer pass.
        Pass
        {
            ...
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesSimpleLitGBufferPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
        ...
        Pass
        {
            ...
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Particles/ParticlesEditorPass.hlsl"
