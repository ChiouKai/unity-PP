...
Shader "Hidden/TerrainEngine/Details/UniversalPipeline/BillboardWavingDoublePass"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Assets/PostProcessing/shader/Copy/URP/Shaders/Terrain/WavingGrassPasses.hlsl"
            ENDHLSL
        }
