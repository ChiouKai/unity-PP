Shader "Hidden/Universal Render Pipeline/GaussianDepthOfField"
{
    HLSLINCLUDE
        ...
        #include "Assets/PostProcessing/shader/Copy/Core/ShaderLibrary/Color.hlsl"
        #include "Assets/PostProcessing/shader/Copy/Core/ShaderLibrary/Filtering.hlsl"
        ...
        #include "Assets/PostProcessing/shader/Copy/URP/ShaderLibrary/DeclareDepthTexture.hlsl"
        ...
        #define NearStart       _CoCParams.z
        #define NearEnd         _CoCParams.w
        ...
        half FragCoC(Varyings input) : SV_Target
        {
            ...
            half FarCoC = saturate((depth - FarStart) / (FarEnd - FarStart));
            half NearCoC = saturate((NearStart - depth)/(NearStart - NearEnd));
            return FarCoC + NearCoC;
        }
