...
public class PPMotionBlur : PPVolumeComponent
{
    ...
    public override bool isActive() => intensity.value > 0f; //&& mode == MotionBlurMode.CameraOnly;

    //public bool IsTileCompatible() => false;


    //public sealed class MotionBlurModeParameter : Parameter<MotionBlurMode> { public MotionBlurModeParameter(MotionBlurMode value, bool overrideState = false) : base(value, overrideState) { } }
    [Serializable]
    public sealed class MotionBlurQualityParameter : Parameter<MotionBlurQuality> { public MotionBlurQualityParameter(MotionBlurQuality value, bool overrideState = false) : base(value, overrideState) { } }
