...
[Serializable]
public class PPFilmGrain : PPVolumeComponent
{
    ...
    public override bool isActive() => intensity.value > 0f && (type.value != FilmGrainLookup.Custom || texture.value != null);
}
[Serializable]
public sealed class FilmGrainLookupParameter : Parameter<FilmGrainLookup> { public FilmGrainLookupParameter(FilmGrainLookup value, bool overrideState = false) : base(value, overrideState) { } }
