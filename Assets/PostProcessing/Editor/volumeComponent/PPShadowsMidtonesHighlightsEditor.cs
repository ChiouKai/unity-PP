...
[VolumeComponentEditor(typeof(PPShadowsMidtonesHighlights))]
sealed class PPShadowsMidtonesHighlightsEditor : PPVolumeComponentEditor
{
    ...
    {
        m_Shadows = Unpack(serializedObject.FindProperty("shadows"));
        m_Midtones = Unpack(serializedObject.FindProperty("midtones"));
        m_Highlights = Unpack(serializedObject.FindProperty("highlights"));
        m_ShadowsStart = Unpack(serializedObject.FindProperty("shadowsStart"));
        m_ShadowsEnd = Unpack(serializedObject.FindProperty("shadowsEnd"));
        m_HighlightsStart = Unpack(serializedObject.FindProperty("highlightsStart"));
        m_HighlightsEnd = Unpack(serializedObject.FindProperty("highlightsEnd"));
    }
