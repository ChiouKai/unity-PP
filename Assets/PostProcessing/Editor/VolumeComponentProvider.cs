...
class VolumeComponentProvider : IProvider
{
    ...
    PPVolumeProfile m_Target;
    PPVolumeComponentListEditor m_TargetEditor;

    public VolumeComponentProvider(PPVolumeProfile target, PPVolumeComponentListEditor targetEditor)
    {
        m_Target = target;
    ...
    public void CreateComponentTree(List<Element> tree)
    {
        ...
        var types = PPManager.instance.baseComponentTypeArray;
        ...
        foreach (var t in types)
        {
            ...
            {
                var attrMenu = attr as PPVolumeComponentMenu;
                if (attrMenu != null)
                    path = attrMenu.menu;
